...
function showQuetions(index){
    ...
    +questions[index].impact[arr[0]]+' Kg CO<sub>2</sub></strong></div>'
    ...
    +questions[index].impact[arr[1]]+' Kg CO<sub>2</sub></strong></div>' 
    ...
    +questions[index].impact[arr[2]]+' Kg CO<sub>2</sub></strong></div>' ;
